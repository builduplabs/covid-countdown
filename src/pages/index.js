  ...
  return (
    <Layout>
      ...
      <div className="w-full flex flex-col justify-center py-16">
        <h2 className="text-4xl text-gray-600 text-center py-2 pb-8 px-4">
          Menos um dia para estarmos juntos outra vez.
        </h2>
        <p className="text-sm text-gray-800 text-justify px-4 py-1">
          Há uma pergunta que todos temos na cabeça:{' '}
          <span className="italic">quanto tempo falta para isto acabar?</span>
        </p>
        <p className="text-sm text-gray-800 text-justify px-4 py-1">
      ...
      <div className="w-full flex flex-col justify-center">
        <h2 className="text-2xl text-gray-600 text-left py-2 px-4">
          Como é feita a previsão
        </h2>
        <p className="text-sm text-gray-800 text-justify px-4 py-1">
          Por vezes ouvimos nas notícias ou briefings da DGS, o termo R0.
        </p>
        <p className="text-base font-medium text-gray-800 text-center px-24 py-3 italic">
        ...
        <p className="text-sm text-gray-800 text-justify px-4 py-1 pb-8">
          Embora o R0 seja uma medida útil, tem como defeito o facto de ser um
          número estático.
        </p>
        <h2 className="text-xl text-gray-600 text-left px-4">Evolução Rt</h2>
        <Graph />
        <p className="text-sm text-gray-800 text-justify px-4 py-1 pt-8">
        ...
        <h2 className="text-sm font-bold text-gray-600 text-left py-2 pt-16 px-4">
          Algumas alterações:
        </h2>
        <ul className="list-disc ml-12">
          <li className="text-xs text-gray-800 pr-4 py-1">
        ...
        <h2 className="text-sm font-bold text-gray-600 text-left py-2 px-4">
